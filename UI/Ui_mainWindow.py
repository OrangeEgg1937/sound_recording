...
" }")
        ...
        self.label_3.setMaximumSize(QtCore.QSize(1000, 12))
        self.label_3.setObjectName("label_3")
        self.verticalLayout_5.addWidget(self.label_3)
        self.waveDisplay = QtWidgets.QWidget(self.Recording)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.waveDisplay.sizePolicy().hasHeightForWidth())
        self.waveDisplay.setSizePolicy(sizePolicy)
        self.waveDisplay.setMinimumSize(QtCore.QSize(500, 300))
        self.waveDisplay.setMaximumSize(QtCore.QSize(500, 300))
        self.waveDisplay.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.waveDisplay.setObjectName("waveDisplay")
        self.verticalLayout_5.addWidget(self.waveDisplay)
...
"}")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Recording), _translate("mainWindow", "Recording"))
